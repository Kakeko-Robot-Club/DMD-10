...
| 項目                  | Symbol          | Max      | 単位 | 
| --------------------- | :-------------: | :------: | :--: | 
| モータ出力電流        | I<sub>OUT</sub> | 15       | A    | 
| モータ電源電圧        | V<sub>DD</sub>  | 16       | V    | 
| ロジック入力電圧      | V<sub>IN</sub>  | 24       | V    | 
| 動作温度             | T<sub>opr</sub> | -50~100  | ℃   | 
### 電気的特性
| 項目                  | Symbol          | Min | Typ. | Max | 単位 | コンディション    | 
| --------------------- | :-------------: | :-: | :--: | :-: | :--: | ----------------- | 
| ロジック入力電圧(High)| V<sub>IH</sub>  | 3.6 | -    | 20  | V    |                   | 
| ロジック入力電圧(Low) | V<sub>IL</sub>  | -   | -    | 1.4 | V    |                   | 
| ロジック入力電流      | I<sub>IN</sub>  | -   | 10   | -   | mA   | V<sub>IN</sub>=5V | 
### その他
| 項目                  | Symbol          | Min | Typ. | Max | 単位 | 備考              | 
| --------------------- | :-------------: | :-: | :--: | :-: | :--: | ----------------- | 
| 基板サイズ(縦)        |                 | -   | 55   | -   | mm   |                   | 
| 基板サイズ(横)        |                 | -   | 60   | -   | mm   |                   | 
...
2. マイコン等から次の表に従い、IN1・IN2に信号を出力する。
	...
	*IN1・IN2については0をV<sub>IL</sub>、1をV<sub>IH</sub>に従うものとする。  
